...
const ImpactSimulatorView: React.FC<ImpactSimulatorViewProps> = ({ documentText, onError }) => {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      ...
      onError(err instanceof Error ? err.message : 'An unknown error occurred during simulation.');
    } finally {
      setIsLoading(false);
    }
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-300 mt-2 max-w-3xl">
          Test potential real-world scenarios against your contract. Enter a situation (e.g., "What if I quit my job after 3 months?") to understand the legal and financial consequences.
        </p>
      </div>
      ...
      {result && (
        <div className="mt-6 p-5 glass-card rounded-lg fade-in">
          <h4 className="font-semibold text-lg text-indigo-300 mb-2">Simulation Result</h4>
